import { CellState, Field } from "./Fields";
import { checkItemInField, getNeigboursItems, incrementNeibours } from "./CellsManipulator";

const {empty, bomb} = CellState;

describe('Check neigbors selectors', ()=>{
    it('With [0, 0] coords', () => {
    ...
    it('should return the correct neighbours for [3, 3] coords', () => {
        expect(getNeigboursItems([3, 3])).toEqual({
          top: [2, 3],
          topRight: [2, 4],
          right: [3, 4],
          rightBottom: [4, 4],
